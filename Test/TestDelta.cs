...
namespace SyncTest
{
    ...
    public class TestDelta
    {
        ...
        public void TwoDifferentTypesButAllTheSame()
        {
            ...
            uint differences =
            Europc.WAM.Management.Diff.DiffSortedEnumerables<int,string, int, string, object, object>(numbers, strings,
                ...
                checkSortOrder: true,
                OnCompared: (Europc.WAM.Management.DIFF_STATE state, int num, string str) =>
                {
                });
        ...
        public void TwoDifferentTypesWithOneDifference()
        {
            ...
            uint differences =
            Europc.WAM.Management.Diff.DiffSortedEnumerables<int, string, int, string, object, object>(
                numbers, strings,
                KeySelectorA: itemA => itemA,
                KeySelectorB: itemB => itemB,
                KeyComparer: (numberA, stringB) => numberA.CompareTo(int.Parse(stringB)),
        ...
        public void TwoDifferentTypesWithModifications()
        {
            ...
            uint differences =
            Europc.WAM.Management.Diff.DiffSortedEnumerables<double, string, double, string, double, string>(
                Anumbers, Bstrings,
                KeySelectorA: itemA => itemA,
                KeySelectorB: itemB => itemB,
